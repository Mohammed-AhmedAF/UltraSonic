...
void LCD_vidWriteNumber(u16 u16NumberCpy) {
	if(u16NumberCpy < 10) {
		...
		{
			LCD_vidWriteCharacter((u16NumberCpy/10000)+'0');
			LCD_vidWriteCharacter((u16NumberCpy%10000)/1000+'0');
			LCD_vidWriteCharacter(((u16NumberCpy%10000)%1000)/100+'0');
			LCD_vidWriteCharacter(((u16NumberCpy%10000)%1000)%100/10+'0');
			LCD_vidWriteCharacter((u16NumberCpy%100)%10+'0');
		}
	}
}
